...
class Config {
  ...
  def nTopicCodes: Int = topicCodes.size
  
  def nIndustryCodes: Int = industryCodes.size
  
  val regionCodes: Array[String] = Array(
"AARCT",
"ABDBI",
"AFGH",
"AFRICA",
...
val topicCodes: Array[String] = Array("1POL",
"2ECO",
"3SPO",
"4GEN",
"6INS",
