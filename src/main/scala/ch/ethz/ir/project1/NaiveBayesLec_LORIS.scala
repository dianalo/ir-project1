 ...
 * */
class NaiveBayesLec (val config: Config, var Pcat: Array[Double], var Pwc: Array[Map[String, Double]]){
   ...
   * */
  def classify(dataFolder: String, threshold: Double) : List[(Int,List[String])] = {
